...
class Ui_AboutDialog(object):
    def setupUi(self, AboutDialog):
        ...
        self.labelDeveloperList_2 = QLabel(AboutDialog)
        self.labelDeveloperList_2.setObjectName(u"labelDeveloperList_2")
        self.labelDeveloperList_2.setGeometry(QRect(120, 130, 261, 16))
        self.labelDeveloperList_2.setFont(font1)
        self.labelDeveloperList_2.setText(u"1.0")
        self.labelDeveloperList_3 = QLabel(AboutDialog)
        self.labelDeveloperList_3.setObjectName(u"labelDeveloperList_3")
        self.labelDeveloperList_3.setGeometry(QRect(120, 150, 261, 16))
        self.labelDeveloperList_3.setFont(font1)
        ...
        self.labelDeveloperList_4 = QLabel(AboutDialog)
        self.labelDeveloperList_4.setObjectName(u"labelDeveloperList_4")
        self.labelDeveloperList_4.setGeometry(QRect(120, 170, 261, 16))
        self.labelDeveloperList_4.setFont(font1)
        self.labelDeveloperList_5 = QLabel(AboutDialog)
        self.labelDeveloperList_5.setObjectName(u"labelDeveloperList_5")
        self.labelDeveloperList_5.setGeometry(QRect(120, 190, 261, 16))
        self.labelDeveloperList_5.setFont(font1)
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.labelDeveloperList_3.setText(QCoreApplication.translate("AboutDialog", u"2025-05-05", None))
        ...
        self.labelDeveloperList_4.setText(QCoreApplication.translate("AboutDialog", u"3.11", None))
        self.labelDeveloperList_5.setText(QCoreApplication.translate("AboutDialog", u"1.8", None))
