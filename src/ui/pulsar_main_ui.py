...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QRect(20, 130, 600, 191))
        self.frame.setFrameShape(QFrame.Panel)
        self.frame.setFrameShadow(QFrame.Plain)
        self.labelSettings = QLabel(self.frame)
        self.labelSettings.setObjectName(u"labelSettings")
        self.labelSettings.setGeometry(QRect(10, 10, 171, 21))
        font = QFont()
        font.setPointSize(11)
        font.setBold(True)
        self.labelSettings.setFont(font)
        self.labelSettings.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.btnSaveSettings.setGeometry(QRect(239, 160, 122, 24))
        ...
        self.checkUseHosts = QCheckBox(self.frame)
        self.checkUseHosts.setObjectName(u"checkUseHosts")
        self.checkUseHosts.setGeometry(QRect(190, 130, 301, 20))
        self.btnConfigureHosts = QPushButton(self.frame)
        self.btnConfigureHosts.setObjectName(u"btnConfigureHosts")
        self.btnConfigureHosts.setEnabled(True)
        self.btnConfigureHosts.setGeometry(QRect(480, 130, 101, 24))
...
"}")
        ...
        self.btnDisconnect.setGeometry(QRect(150, 340, 340, 51))
...
"}")
        ...
        self.btnStatus.setGeometry(QRect(210, 410, 220, 24))
        self.btnQuit = QPushButton(self.centralwidget)
        self.btnQuit.setObjectName(u"btnQuit")
        self.btnQuit.setGeometry(QRect(260, 410, 120, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkUseHosts.setText(QCoreApplication.translate("MainWindow", u"Register Nebula network hosts locally", None))
        self.btnConfigureHosts.setText(QCoreApplication.translate("MainWindow", u"Configure...", None))
